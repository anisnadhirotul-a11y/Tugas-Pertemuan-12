...
<form action="<?php echo e(route('buku.destroy', $buku->id)); ?>" method="POST" class="delete-form">
                 <?php echo csrf_field(); ?>
                 <?php echo method_field('DELETE'); ?>
    <button type="button" class="btn btn-danger w-100 btn-delete" data-judul="<?php echo e($buku->judul); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\perpustakaan-9\resources\views/buku/show.blade.php ENDPATH**/ ?>